...
- Diferença entre INTERNET e WEB
	- INTERNET comunicação através do protocolo IP
...
### >>> Aula 3 - Endereçamento IP, Sub-redes e Portas
...
### >>> Aula 5 - Serviços e Aplicações na Internet
- API RESTFul
...
### >>> Aula 7 -  Arquitetura da Internet
- Backbones
...
- IPV4 e IPV6
### >>> Aula 8 - Redes de computadores
* Latencia

- Funcionamento e exemplos praticos
...
* Arquiteturas Ethernet e Token Ring
	...
	- como o Token ring é melhor

	- Conceito de lista circular


### >>> Aula 9 - Segurança de redes
- Ameaças a segurança de redes

- Principais ameaças

	- IA e o perido da engenharia social
...
- VPNs
	...
	- Alternativa ao site-a-site para rede

- Diferença entre conteiner e virtual machine
...
- Branchs
	...
	- Uso seguro através das branchs
...
- Achar um equilíbrio na maneira de passar uma mensagem ao falar, para não ser interpretado de maneira errada
## Comunicação Ativa
- Buscar prestar atenção na conversa e demonstrar isso paro o emissor da mensagem
## Elementos de Comunicação
- Emissor - Receptor - Mensagem - Código - Canal - Contexto
## Feedback
- Pode ser uma resposta em uma conversa ou uma avaliação que pode ser positiva, negativa ou construtiva, servindo para reforçar acertos, sugerir melhorias e alinhar expectativas.
## Linguagem não verbal
- Se expressar sem uso de palavras
	- Expressões faciais
